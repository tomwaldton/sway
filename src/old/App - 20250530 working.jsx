...
<div style={{ position: 'absolute', top: '-10000px', left: '-10000px' }}>
  <div ref={testPrintRef} style={{ padding: '20px', backgroundColor: 'white', border: '1px solid black' }}>
    <h2>✅ Test Print Box</h2>
    <p>This should print if everything is wired correctly.</p>
  </div>
</div>
