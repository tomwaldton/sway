...
onChange={(e) => {
  ...
  updatedCharacters[index].primarySkill = e.target.value;
...
onChange={(e) => {
  const updatedCharacters = [...characters];
  updatedCharacters[index].secondarySkill = e.target.value;
  setCharacters(updatedCharacters);
}}
...
onChange={(e) => {
  const updatedCharacters = [...characters];
  updatedCharacters[index].armourType = e.target.value;
  setCharacters(updatedCharacters);
}}
      ...
      <div key={idx}>
        ...
        <div className="flex gap-4 items-start">
          ...
          <select
            ...
            onChange={(e) => {
              const updated = [...characters];
              updated[index][weaponKey] = e.target.value;
              setCharacters(updated);
            }}
          >
          ...
          <select
            ...
            onChange={(e) => {
              const updated = [...characters];
              updated[index][upgradeKey] = e.target.value;
              setCharacters(updated);
            }}
          >
    ...
    <div key={index} className="flex gap-2 mb-2 items-start">
      <div className="flex flex-col w-[140px]">
        <select
          ...
          onChange={(e) => {
            const updated = [...characters];
            updated[index].items[index] = e.target.value;
            setCharacters(updated);
          }}
        >
          {itemOptions.map((opt) => (
...
<input
  type="checkbox"
  checked={char.usedItems[index]}
  onChange={(e) => {
    const updatedCharacters = [...characters];
    const newUsedItems = [...char.usedItems];
    newUsedItems[index] = e.target.checked;
    updatedCharacters[index].usedItems = newUsedItems;
    setCharacters(updatedCharacters);
  }}
/>
...
<div className="flex-[1_1_27%]">
  ...
  <select
    ...
    onChange={(e) => {
  const updated = [...characters];
  updated[index].accessory = e.target.value;
  setCharacters(updated);
}}
...
updatedCharacters[index].injuries = updatedInjuries;
setCharacters(updatedCharacters);
...
<div id="print-clone" className="print-clone screen-hidden">

  <div className="flex flex-wrap justify-start">
    {characters.map((char, i) => (
      <div key={i} className="character-sheet-print p-4 w-[500px] border rounded shadow bg-white m-2">
        <h2>{char.name || `Character ${i + 1}`}</h2>
        <p>Level: {char.level}</p>
        <p>Cost: {calculateCostForCharacter(char)}</p>
        <p>STR: {char.stats.STR}, INT: {char.stats.INT}, DED: {char.stats.DED}, CHA: {char.stats.CHA}, AGI: {char.stats.AGI}</p>
        <p>Primary Skill: {char.primarySkill}</p>
        <p>Secondary Skill: {char.secondarySkill}</p>
      </div>
    ))}
  </div>
</div>
