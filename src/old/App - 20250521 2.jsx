...
<div className="character-sheet-area flex-1 relative overflow-x-auto">
  <div className="flex min-h-screen w-max gap-4 p-4">
    {characters.map((char, index) => {
  const stats = char.stats;
  const modifiers = getModifiersForCharacter(char);

      return (
        <div key={index} className="p-4 w-[500px] border rounded shadow bg-white flex-shrink-0">
