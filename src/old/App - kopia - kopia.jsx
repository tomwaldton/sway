      ...
      >
          ...
          <div className="flex-1">
            <div className="flex gap-2">
              ...
              <label className="flex-1 header-text">
                ...
                <div className="description-text mt-1 w-full border rounded p-2 desc-box-interactive" style={{ height: '165px', overflow: 'hidden' }}
        ...
        <div className="flex gap-4 mt-[4px] sm:mt-[10px]">
            ...
            {char.items.map((item, itemIdx) => {
              ...
              return (
                <div key={itemIdx} className="flex gap-2 mb-2 items-start">
                  ...
                  <div
                    className={`flex-1 description-text p-2 border rounded desc-box-interactive ${selectedItem?.description ? 'cursor-pointer' : ''}`}
          ...
          <div className="flex-[1_1_27%]">
            ...
            <div
              className={`description-text mt-2 w-full border rounded p-2 desc-box-interactive ${accessoryOptions.find(a => a.name === char.accessory)?.description ? 'cursor-pointer' : ''}`}
        ...
        {/* Injuries + Level + Cost */}
        <div className="flex gap-2 items-end mt-[4px] sm:mt-[10px]">
          <div className="flex flex-col flex-1 min-w-0">
            ...
            <div className="flex gap-1">
              {char.injuries.map((val, i) => (
                <select
                  key={i}
                  className="flex-1 min-w-0 border p-1 rounded input-text text-center"
                  value={val}
                  onChange={(e) => setCharacters(prev => {
                    const updated = [...prev];
